...
//		driver.findElementByXPath("//android.widget.Button[@text='ALLOW']").click();
	...
	
	{
		...
		menu.click();
		driver.findElementByXPath("//android.widget.TextView[@text='Find a dealer']").click();
		ZoomInAndOut();
	}
	private Collection<Sequence> zoom(Point locus, int startRadius, int endRadius, int pinchAngle, Duration duration) {
		...
		*/
		...
		WebElement map = driver.findElementByXPath("//*[@content-desc='']");
		map.click();
